#The r script follows the following steps to perform species distribution 
#modelling for Coffee arabica#
#ACTIVATE LIBRARIES
library(sdm)
library(shiny)
library(sp)
...
#  create a a folder containing study area boundary shape file and load study area polygon 
...
# load historical GCM : time range  1970-2000
...
# retain all needed GCMs obtained from worldclim database (https://www.worldclim.org/data/worldclim21.html)
...
#WORKING DIRECTORY
setwd("C:/PACSMAC/Objective 2 data/Ethiopia EUDR Comparisons") ##(drop here in individual folders)/Ethiopia EUDR Comparisons
#GET FILES
